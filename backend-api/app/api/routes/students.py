...
async def upload_image_url(
    ...
    # 2. Register face with ML service
    try:
        ml_response = await ml_service_client.register_face(
    ...
    # 4. Update student record (verified status and image URL)
    # Note: Embeddings are now stored in ML service, not in database
